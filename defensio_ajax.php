...
if(file_exists($plugin_path.'../../../wp-admin/admin-functions.php')) { require_once($plugin_path.'../../../wp-admin/admin-functions.php'); }
if(file_exists($plugin_path.'../../../wp-admin/admin-db.php')) { require_once($plugin_path.'../../../wp-admin/admin-db.php'); }
if(file_exists($plugin_path.'../../../wp-admin/admin.php')) { require_once($plugin_path.'../../../wp-admin/admin.php'); }
